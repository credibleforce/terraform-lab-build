...
sudo git clone --branch develop --recursive https://github.com/credibleforce/splunk-build-ansible /opt/repo/splunk-engagement-ansible
sudo git clone --branch develop --recursive https://github.com/credibleforce/ansible-invoke-atomic-redteam /opt/awx/projects/redcanary
