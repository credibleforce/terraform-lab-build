...
module "lab1" {
    ...
    student_id                  = "lab1"
    win_user                    = local.ansible_lab_vars.win_admin_user
    win_password                = local.ansible_lab_vars.win_admin_password
    win_dns_domain              = local.ansible_lab_vars.win_dns_domain
