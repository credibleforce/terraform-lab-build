...
locals {
    ...
    ansible_lab_vars = {
        ...
        ansible_vault_password  = local.ansible_vault_password
...
resource "null_resource" "vault-passwd" {
    provisioner "local-exec" {
        command                 = "echo -n '${local.ansible_vault_password}' > '${path.root}/settings/vault_passwd.txt'"
    }
}
...
module "lab1" {
    ...
    ansible_vault_password      = local.ansible_lab_vars.ansible_vault_password
    lab_base_tld                = local.lab_base_tld
    lab_base_name               = local.lab_base_name
...
# // add additional dns records internally
# module "lab6_internal_dns" {
#     module_name                 = "lab6_internal_dns"
#     module_dependency       = module.lab6.module_complete

#     source                      = "./modules/ec2_internal_dns_record"
#     zone_id                     = module.lab6.internal_zone_id
#     records                     =   [
#                                         {
#                                             name = "deployer"
#                                             type = "CNAME"
#                                             target = module.lab6.ansible_instances[0].private_dns
#                                         }
#                                     ]
# }

// add public dns records (in the format NAME.STUDENT_ID.PUBLIC_DOMAIN)
module "lab6_public_dns_mapping" {
    module_name                 =   "lab6_public_dns_mapping"
    module_dependency           =   module.lab6.module_complete

    source                      =   "./modules/ec2_public_dns_mapping"
    public_domain               =   module.lab6.public_domain
    vpc_id                      =   module.lab6.vpc_id
    vpc_subnet                  =   module.lab6.vpc_subnet
    subnet1_id                  =   module.lab6.subnet1_id
    subnet2_id                  =   module.lab6.subnet2_id
    student_id                  =   module.lab6.student_id
    instances                   =   module.lab6.instances
    subdomains                  =   local.public_dns_mapping
}

// copy over extended ansible setup
module "lab6_files" {
    module_name                 = "lab6_files"
    module_dependency           = module.lab6.module_complete

    source                  = "./modules/ec2_provision_file"
    connection_settings     =   { 
                                    host = module.lab6.ansible_instances[0].public_ip,
                                    user = local.ansible_user, 
                                    private_key = file(replace(local.public_key_path,".pub","")) 
                                }
    files_copy              =   [
...
# // execute extended ansible setup
module "lab6_script_exec" {
    module_name             = "lab6_script_exec"
    module_dependency       = module.lab6_files.module_complete
...
# // add additional dns records internally
# module "lab7_internal_dns" {
#     module_name                 = "lab7_internal_dns"
#     module_dependency       = module.lab7.module_complete

#     source                      = "./modules/ec2_internal_dns_record"
#     zone_id                     = module.lab7.internal_zone_id
#     records                     =   [
#                                         {
#                                             name = "deployer"
#                                             type = "CNAME"
#                                             target = module.lab7.ansible_instances[0].private_dns
#                                         }
#                                     ]
# }

// add public dns records (in the format NAME.STUDENT_ID.PUBLIC_DOMAIN)
module "lab7_public_dns_mapping" {
    module_name                 =   "lab7_public_dns_mapping"
    module_dependency           =   module.lab7.module_complete

    source                      =   "./modules/ec2_public_dns_mapping"
    public_domain               =   module.lab7.public_domain
    vpc_id                      =   module.lab7.vpc_id
    vpc_subnet                  =   module.lab7.vpc_subnet
    subnet1_id                  =   module.lab7.subnet1_id
    subnet2_id                  =   module.lab7.subnet2_id
    student_id                  =   module.lab7.student_id
    instances                   =   module.lab7.instances
    subdomains                  =   local.public_dns_mapping
}

// copy over extended ansible setup
module "lab7_files" {
    module_name                 = "lab7_files"
    module_dependency           = module.lab7.module_complete

    source                  = "./modules/ec2_provision_file"
    connection_settings     =   { 
                                    host = module.lab7.ansible_instances[0].public_ip,
                                    user = local.ansible_user, 
                                    private_key = file(replace(local.public_key_path,".pub","")) 
                                }
    files_copy              =   [
...
# // execute extended ansible setup
module "lab7_script_exec" {
    module_name             = "lab7_script_exec"
    module_dependency       = module.lab7_files.module_complete
...
# // add additional dns records internally
# module "lab8_internal_dns" {
#     module_name                 = "lab8_internal_dns"
#     module_dependency       = module.lab8.module_complete

#     source                      = "./modules/ec2_internal_dns_record"
#     zone_id                     = module.lab8.internal_zone_id
#     records                     =   [
#                                         {
#                                             name = "deployer"
#                                             type = "CNAME"
#                                             target = module.lab8.ansible_instances[0].private_dns
#                                         }
#                                     ]
# }

// add public dns records (in the format NAME.STUDENT_ID.PUBLIC_DOMAIN)
module "lab8_public_dns_mapping" {
    module_name                 =   "lab8_public_dns_mapping"
    module_dependency           =   module.lab8.module_complete

    source                      =   "./modules/ec2_public_dns_mapping"
    public_domain               =   module.lab8.public_domain
    vpc_id                      =   module.lab8.vpc_id
    vpc_subnet                  =   module.lab8.vpc_subnet
    subnet1_id                  =   module.lab8.subnet1_id
    subnet2_id                  =   module.lab8.subnet2_id
    student_id                  =   module.lab8.student_id
    instances                   =   module.lab8.instances
    subdomains                  =   local.public_dns_mapping
}

// copy over extended ansible setup
module "lab8_files" {
    module_name                 = "lab8_files"
    module_dependency           = module.lab8.module_complete
    
    source                  = "./modules/ec2_provision_file"
    connection_settings     =   { 
                                    host = module.lab8.ansible_instances[0].public_ip,
                                    user = local.ansible_user, 
                                    private_key = file(replace(local.public_key_path,".pub","")) 
                                }
    files_copy              =   [
...
# // execute extended ansible setup
module "lab8_script_exec" {
    module_name             = "lab8_script_exec"
    module_dependency       = module.lab8_files.module_complete
...
# # // add additional dns records internally
# # module "lab9_internal_dns" {
# #     module_name                 = "lab9_internal_dns"
# #     module_dependency       = module.lab9.module_complete

# #     source                      = "./modules/ec2_internal_dns_record"
# #     zone_id                     = module.lab9.internal_zone_id
# #     records                     =   [
# #                                         {
# #                                             name = "deployer"
# #                                             type = "CNAME"
# #                                             target = module.lab9.ansible_instances[0].private_dns
# #                                         }
# #                                     ]
# # }

# // add public dns records (in the format NAME.STUDENT_ID.PUBLIC_DOMAIN)
# module "lab9_public_dns_mapping" {
#     module_name                 =   "lab9_public_dns_mapping"
#     module_dependency           =   module.lab9.module_complete

#     source                      =   "./modules/ec2_public_dns_mapping"
#     public_domain               =   module.lab9.public_domain
#     vpc_id                      =   module.lab9.vpc_id
#     vpc_subnet                  =   module.lab9.vpc_subnet
#     subnet1_id                  =   module.lab9.subnet1_id
#     subnet2_id                  =   module.lab9.subnet2_id
#     student_id                  =   module.lab9.student_id
#     instances                   =   module.lab9.instances
#     subdomains                  =   local.public_dns_mapping
# }

# // copy over extended ansible setup
# module "lab9_files" {
#     module_name                 = "lab9_files"
#     module_dependency           = module.lab9.module_complete

#     source                  = "./modules/ec2_provision_file"
#     connection_settings     =   { 
#                                     host = module.lab9.ansible_instances[0].public_ip,
#                                     user = local.ansible_user, 
#                                     private_key = file(replace(local.public_key_path,".pub","")) 
#                                 }
#     files_copy              =   [
...
# # // execute extended ansible setup
# module "lab9_script_exec" {
#     module_name             = "lab9_script_exec"
#     module_dependency       = module.lab9_files.module_complete
